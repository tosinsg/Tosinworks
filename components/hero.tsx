...
export default function Hero() {
  ...
  return (
    <section id="home" className="container-custom" style={{ paddingTop: 200, paddingBottom: 80, minHeight: "100vh", display: "flex", alignItems: "center" }}>
      <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 60, alignItems: "center", width: "100%" }}>
        <div>
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 34, flexWrap: "wrap" }}>
            ...
            <GlassLink id="hero-cta" href="#work" className="btn" style={{ color: "#f3f3f0" }}>
              View My Projects →
            </GlassLink>
          </div>
        </div>
